...
import JeuBaseTexte.character.Character;
...
public class Game {
	...
	public Game( World world,PlayableCharacter hero ){
		this.world = world;
		this.hero=hero;
	...
	/*Renvoi l'index de l'objectif (fourni en paramètre) dans la liste des objectifs */
