package JeuBaseTexte.character;

import JeuBaseTexte.storage.Chest;
import JeuBaseTexte.item.EadableItem;
import JeuBaseTexte.item.EquipableItem;
import JeuBaseTexte.Exit;
import JeuBaseTexte.storage.Inventory;
import JeuBaseTexte.item.Item;
import JeuBaseTexte.item.ShieldItem;
import JeuBaseTexte.item.SwordItem;
	...
	public boolean eat(String nameItem){
		...
		if(this.location.enemyCharacters.containsKey(enemyName)){
			...
			if(fled){
				...
				System.out.println("#		    || Congratulations ! You defeated "+enemy+" !\n#         ||");
