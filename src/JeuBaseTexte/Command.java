...
public enum Command {
	...
	public static boolean stringOnlySpaces(String string) {
		...
		return isEmpty;
		 ...
		 //Fonction qui permet de concaténer les paramètre de la commande à partir du deuxieme paramètre , meme si celui si est séparé en pusieurs             
